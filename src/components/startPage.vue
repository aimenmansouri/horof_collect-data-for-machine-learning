<template>
  <div class="flex flex-col justify-center items-center h-screen">
    <button @click="start" :class="{ 'opacity-0': inApp }"
      class="bg-white text-theme-100 text-2xl w-20 h-20 
        rounded-full transition-all duration-700 hover:bg-theme-400">
    ...
    <select  v-model="time" class="select select-ghost w-full max-w-xs mt-5 transition-opacity duration-700" :class="{ 'opacity-0': inApp }">
